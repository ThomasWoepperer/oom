...
namespace Task6
{
	public class Auto : IAusgabe, ISubject<Auto>
	{ 
		...
		{
			Console.WriteLine("Error occured in Auto");
		}

		public void OnCompleted()
		{
			Console.WriteLine("Auto finished.");
		}

		public IDisposable Subscribe(IObserver<Auto> observer)
		{
